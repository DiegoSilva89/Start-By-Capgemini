...
public class Task {
    ...
    //Atributos referentes aos campos criados na tabela Tasks do banco de dados
    private int id;
    ...
    public void setUpdatedAt(Date updatedAt) {
     ...
     //método toString. método público que retorna uma string com nome do atributo e valor que está armazenado no atributo.
    @Override
